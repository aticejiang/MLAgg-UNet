...
from nnunetv2.network_architecture.mednextv1.blocks_new import *
...
class MedNeXt(nn.Module):
    ...
    def __init__(self, 
        ...
        strides=[2,2,2,2,2,2,2,2],          # new, int strides
        norm_type = 'group',
        dim = '3d',                                # 2d or 3d
        grn = False
    ):
        ...
        self.mambaskip = VSS_Conv_Layer(
            [n_channels, n_channels * 2, n_channels * 4, n_channels * 8, n_channels * 16],
            n_channels//2,
            depth=1,
            drop_path=0.1,
    ...
    def forward(self, x):
        ...
        if self.outside_block_checkpointing:
            ...
            x_res_0, x_res_1, x_res_2, x_res_3, x = self.mambaskip([x_res_0, x_res_1, x_res_2, x_res_3, x])
