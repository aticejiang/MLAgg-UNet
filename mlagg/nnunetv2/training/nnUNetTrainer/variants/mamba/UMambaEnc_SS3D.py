# =============================================================
# 在UMambaEnc_3d基础上，将Mamba模块替换为SS3D模块
# =============================================================
...
class VSSBlock(nn.Module):
    def __init__(
        ...
        self.mlp = Mlp(hidden_size=hidden_dim, mlp_dim=mlp_hidden_dim, act="GELU", dropout_rate=mlp_drop_rate, dropout_mode="swin")
