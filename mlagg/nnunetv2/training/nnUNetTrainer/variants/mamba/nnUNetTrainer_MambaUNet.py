...
###################################### It is a 2D method #########################################
class nnUNetTrainerMambaUNet(nnUNetTrainerNoDeepSupervision):
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = VSSM(in_chans=num_input_channels,
...
class MambaUnet(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False):
        ...
        self.mamba_unet = VSSM(patch_size=config.MODEL.VSSM.PATCH_SIZE,
